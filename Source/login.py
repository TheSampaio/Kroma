...
class FormMain(Form):
    ...
    def __init__(self) -> None:
        ...
        self.__Lbl_User = self._CreateSubobject_(Label())
        ...
        self.__Txt_User = self._CreateSubobject_(TextBox())
        ...
        self.__Lbl_Password = self._CreateSubobject_(Label())
        ...
        self.__Txt_Password = self._CreateSubobject_(TextBox())
        ...
        self.__Btn_Login = self._CreateSubobject_(Button())
        ...
        self.__Btn_Close = self._CreateSubobject_(Button())
        ...
        self.__Lbl_Footer = self._CreateSubobject_(Label())
